...
import { query, cleanup_query_result } from '../actions'
...
class Dashboard extends React.Component {
  ...
  componentWillUnmount() {
    this.props.cleanup_query_result()
  }
  render() {
    const self = this
...
export default connect(state => ({ maybe_dashboard: state.dashboard, params: state.controls }), { query, cleanup_query_result })(Dashboard)
